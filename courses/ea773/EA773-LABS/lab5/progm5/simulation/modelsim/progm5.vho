...
-- d_out[2]	=>  Location: PIN_AA9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- d_out[1]	=>  Location: PIN_V11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- d_out[0]	=>  Location: PIN_Y17,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- addr[2]	=>  Location: PIN_R11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- addr[0]	=>  Location: PIN_W11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- addr[1]	=>  Location: PIN_AB9,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF progm5 IS
...
-- Equation(s):
-- \inst2~1_combout\ = (\addr~combout\(0) & ((\addr~combout\(2)))) # (!\addr~combout\(0) & ((!\addr~combout\(2)) # (!\addr~combout\(1))))
...
-- Equation(s):
-- \inst4~1_combout\ = (!\addr~combout\(1) & ((!\addr~combout\(2)) # (!\addr~combout\(0))))
