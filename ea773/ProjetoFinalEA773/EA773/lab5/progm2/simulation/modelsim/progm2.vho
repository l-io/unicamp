...
-- addr[1]	=>  Location: PIN_R7,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- addr[0]	=>  Location: PIN_D6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- addr[2]	=>  Location: PIN_N4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF progm2 IS
...
-- Equation(s):
-- \inst2~1_combout\ = (!\addr~combout\(2) & (\addr~combout\(1) $ (\addr~combout\(0))))
...
-- Equation(s):
-- \inst4~1_combout\ = (\addr~combout\(1) & (!\addr~combout\(0) & !\addr~combout\(2)))
...
-- Equation(s):
-- \inst7~1_combout\ = (\addr~combout\(1) & (\addr~combout\(0) & !\addr~combout\(2)))
